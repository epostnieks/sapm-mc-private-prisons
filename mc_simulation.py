#!/usr/bin/env python3
"""
SAPM Monte Carlo Simulation — Private Prisons / Occupancy Guarantee Trap
==========================================

Reproduces all quantitative results in:

  Postnieks, E. (2026). SAPM Working Paper: Private Prisons (Occupancy Guarantee Trap).
  Available: SSRN.
...
CONFIG = {
    "paper_id": "private_prisons",
    "domain_name": "Private Prisons",
    "theorem": "Occupancy Guarantee Trap",
    "classification": "Class 2 \u2014 Intractability",
    "seed": 42,
    "n_draws": 100000,
    "correlation_rho": 0.3,
    "private_payoff_B": 8.0,
    "channels": {
        "C1_over_incarceration": {
            "dist": "lognormal",
            "low": 21.0,
            "mid": 38.1,
            "high": 62.9,
            "weight": 0.35,
            "description": "Lobbying for longer sentences, mandatory minimums. Private prison occupancy guarantees drive over-incarceration. Sources: Sentencing Project, Justice Policy Institute."
        },
        "C2_human_capital_destruction": {
            "dist": "lognormal",
            "low": 13.1,
            "mid": 23.8,
            "high": 39.3,
            "weight": 0.25,
            "description": "Recidivism, intergenerational transmission of incarceration. Lost earnings, family disruption. Sources: Pew, Vera Institute."
        },
        "C3_monopoly_captive_extraction": {
            "dist": "normal",
            "low": 15.2,
            "mid": 19.0,
            "high": 22.8,
            "weight": 0.2,
            "description": "Price gouging on phone calls, commissary, medical co-pays in captive market. Sources: Prison Policy Initiative, FCC."
        },
        "C4_institutional_defense_failure": {
            "dist": "lognormal",
            "low": 5.2,
            "mid": 9.5,
            "high": 15.7,
            "weight": 0.1,
            "description": "Inadequate healthcare, understaffing, violence. DOJ consent decrees. Sources: DOJ Civil Rights Division, ACLU."
        },
        "C5_governance_political_feedback": {
            "dist": "lognormal",
            "low": 2.6,
            "mid": 4.8,
            "high": 7.9,
            "weight": 0.1,
            "description": "Campaign contributions, ALEC model legislation, revolving door. Sources: Justice Policy Institute, OpenSecrets."
        }
    },
    "impossibility_floor": 6.5
}
