# SAPM Monte Carlo — Private Prisons / Occupancy Guarantee Trap

**Public replication repository for quantitative results in:**

> Postnieks, E. (2026). *Private Prisons (Occupancy Guarantee Trap).* SAPM Working Paper. SSRN.
...
**β_W = 12.08** means the private prisons industry destroys **$12.08 in system
...
```bash
git clone https://github.com/epostnieks/sapm-mc-private-prisons.git
cd sapm-mc-private-prisons
pip install numpy scipy
python mc_simulation.py
```

Expected output: `β_W median : 12.08` and `ΔW median : $96.7B/yr`
...
|---------|---------------|--------|--------------|
| C1_over_incarceration | $38.1B | [$23.0B, $62.6B] | Lognormal |
| C2_human_capital_destruction | $23.8B | [$14.4B, $39.3B] | Lognormal |
| C3_monopoly_captive_extraction | $19.0B | [$15.2B, $22.8B] | Normal |
| C4_institutional_defense_failure | $9.5B | [$5.8B, $15.7B] | Lognormal |
| C5_governance_political_feedback | $4.8B | [$2.9B, $7.9B] | Lognormal |
| **Total ΔW** | **$96.7B** | **[$70.6B, $134.1B]** | Correlated (ρ=0.3) |

---

## Impossibility Floor

The floor β_W ≥ 6.5 cannot be breached by any policy while the
...
> Postnieks, E. (2026). *SAPM Monte Carlo — Private Prisons (Occupancy Guarantee Trap)*.
> GitHub: epostnieks/sapm-mc-private-prisons.
> https://github.com/epostnieks/sapm-mc-private-prisons
